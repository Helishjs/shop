            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm">
                            Khám phá thế giới tri thức qua những trang sách hay. Mỗi cuốn sách là một hành trình mới.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/store" className="hover:text-white transition-colors">Cửa hàng</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <p className="text-sm mb-4">
                            Nhận thông tin về sách mới, khuyến mãi đặc biệt và nhiều hơn nữa
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <div className="flex space-x-6">
                            ...
                            <a href="#" className="text-sm hover:text-white transition-colors">Chính sách cookie</a>
                        </div>
                    </div>
                </div>
            </div>
